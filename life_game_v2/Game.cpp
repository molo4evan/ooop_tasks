...
void Game::set_field(Field* f){
    field = f;
}

Field* Game::get_backuped_field(){
    return backuped_field;
}

void Game::set_backuped_field(Field* f){
    backuped_field = f;
}

unsigned int Game::get_steps(){
    return steps;
}
...
bool Game::get_backed(){
    return backed;
}

void Game::set_backed(bool state){
    backed = state;
}
